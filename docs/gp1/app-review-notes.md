# App Review に関する情報（備考欄）— 英検準1級（GP1）
...
**備考欄は4,000文字まで。** 下の文面は 3,924 文字で、余裕は 76 文字。
...
Eiken Grade Pre-1 test, mainly university students and working adults. It needs
no sign-up or connection and shows no ads, so it works offline and stores
nothing off the device. It bundles 4,869 words with meanings and example
sentences, including 447 idioms, and offers four study modes (word list with
...
(com.eitango.gp2), Grade 3 (com.eitango.g3), Grade 4 (com.eitango.g4); Grade 3
...
Not a regulated industry; no third-party protected material. All 4,869 words,
...
Product ID com.eitango.gp1.unlock.core, "準1級コア発展語彙の解放" (Unlock Grade
Pre-1 core advanced vocabulary), JPY 600. It permanently adds 1,491 advanced
...
This is not a trial version. For 14 days after installation all 4,869 words are
...
that the quiz/typing/listening pool drops to 3,378 words, and the remaining
1,491 are what the purchase unlocks. The word list continues to show, search
and pronounce all 4,869 words regardless of purchase. No functionality expires.
...
| 箇所 | 準2級 | 準1級 |
| --- | --- | --- |
| 級名 | Grade Pre-2 | Grade Pre-1 |
| 対象読者 | 14〜16歳 | 大学生・社会人 |
| 総語数 | 3,325 | 4,869 |
| 熟語数 | 637 | 447 |
| 課金で増える語数 | 1,182 | 1,491 |
| 試用終了後の出題語数 | 2,143 | 3,378 |
| プロダクトID | `com.eitango.gp2.unlock.core` | `com.eitango.gp1.unlock.core` |
| 価格 | JPY 500 | JPY 600 |

項目3のシリーズ列挙には、**そのとき公開済み・審査済みの級だけを書く**。
準1級を出す時点で準2級が公開されていなければ、その行は落とす（未公開のアプリを
「公開している」と書かない）。
