...
Editions/
  ...
  GP2/                 準2級（パイロット）
  GP1/  G1/            準1級・1級（Phase 3。実装完了 2026-09-20）
  ...                  G4 / G3 / GP1 / G1 / TOEIC
vocab/                 語彙マスター（§5）
scripts/
...
| GP1 | 3級〜2級帯 | 2級コアからの選抜529語＋準1級帯の頻出語168語 | 準1級帯（B2）1,491語 |
| G1 | 2級までの既習語 | 準1級コアからの選抜409語 | 1級帯（C1）1,219語 |
...
| Phase | 内容 | 完了条件 |
| --- | --- | --- |
| **0. 基盤** ✅ | EditionSpec 抽出 / targetTemplates 化 / vocab マスター逆輸入と生成・一致テスト / CI 対応 | **2026-09-12 完了・main マージ済み**。2級アプリは無変更（既存テスト全通過・スクリーンショット差なし・seed 再現一致） |
